...
| [uftdev-aos-for-340-complex-AM](https://github.com/admpresales/uftdev-aos-for-340-complex-AM.git) | N/A                    | This test is used as a resource for the UFT Developer level 340 training.<br><br>It is a solution for the Complex AM workflow, where the AM is created first, then steps are added. |
...
| [uftone-aos-web-create-account](https://github.com/admpresales/uft-create-aos-account.git) | uft-gui-create-aos-account               | This UFTOne script creates a new account in AOS |
